...
#Players
Players <- c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh",
...
FreeThrows
colnames(FreeThrows) <- Seasons #update column names
rownames(FreeThrows) <- Players #update row names
FreeThrows
